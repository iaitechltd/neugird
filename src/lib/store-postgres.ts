...
const SPECS: Spec[] = [
  ...
  { key: "positions", table: "positions",
    cols: ["position_id", "market_id", "user_id", "side", "size", "leverage", "entry_price", "margin", "liquidation_price", "status", "opened_at", "closed_at", "pnl", "mandate_id", "agent_id", "pnl_booked"],
    num: ["size", "leverage", "entry_price", "margin", "liquidation_price", "pnl"], ts: ["opened_at", "closed_at"] },
  { key: "orders", table: "orders",
    cols: ["order_id", "market_id", "user_id", "side", "price", "qty", "filled", "status", "created_at", "filled_at"],
    num: ["price", "qty", "filled"], ts: ["created_at", "filled_at"] },
