...
const SPECS: Spec[] = [
  ...
  { key: "jobs", table: "jobs",
    cols: ["job_id", "context", "grid_id", "subgrid_id", "campaign_id", "build_id", "title", "description", "required_skills", "executor_kind", "assignee_id", "assignee_type", "reward_amount", "reward_token", "escrow_id", "proof_required", "proof", "verification", "status", "created_by", "dispute_deadline", "created_at", "updated_at"],
  ...
  { key: "markets", table: "markets",
    cols: ["market_id", "token_id", "grid_id", "stage", "base_symbol", "quote_symbol", "liquidity_usd", "holders", "base_reserve", "quote_reserve", "price", "volume", "eligibility", "status", "stage_changed_at", "fraud_flags", "onchain", "founder_allocation", "dividends", "created_at"],
    num: ["liquidity_usd", "holders", "base_reserve", "quote_reserve", "price", "volume"], ts: ["stage_changed_at", "created_at"], json: ["eligibility", "fraud_flags", "onchain", "founder_allocation", "dividends"] },
  { key: "holdings", table: "holdings",
    cols: ["market_id", "user_id", "base", "div_debt"], num: ["base", "div_debt"] },
