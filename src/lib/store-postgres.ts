...
const SPECS: Spec[] = [
  { key: "users", table: "users",
    cols: ["id", "wallet_addresses", "username", "avatar", "bio", "skills", "listing", "referred_by", "referral_verified_at", "roles_by_grid", "pulse_score", "reputation", "reward", "joined_grids", "created_at"],
    num: ["pulse_score"], ts: ["created_at", "referral_verified_at"], json: ["listing", "roles_by_grid", "reputation", "reward"], arr: ["wallet_addresses", "skills", "joined_grids"] },
  ...
  { key: "agents", table: "agents",
    cols: ["agent_id", "owner_id", "grid_id", "name", "capabilities", "permissions", "tools_granted", "task_history", "rating", "trading_rating", "status", "origin", "external_framework", "wallet_address", "reputation", "owner_split_bps", "trust_tier", "bond_amount", "spend_limit_per_job", "earnings", "api_key", "api_key_hash", "persona", "work", "skill_library", "offer_policy", "created_at"],
    num: ["rating", "trading_rating", "owner_split_bps", "bond_amount", "spend_limit_per_job", "earnings"], ts: ["created_at"], json: ["reputation", "persona", "work", "skill_library", "offer_policy"], arr: ["capabilities", "permissions", "tools_granted", "task_history"] },
  { key: "jobs", table: "jobs",
