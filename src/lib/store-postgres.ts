...
const SPECS: Spec[] = [
  ...
  { key: "orders", table: "orders",
    cols: ["order_id", "market_id", "user_id", "side", "price", "qty", "filled", "status", "created_at", "filled_at", "kind", "pside", "collateral", "leverage"],
    num: ["price", "qty", "filled", "collateral", "leverage"], ts: ["created_at", "filled_at"] },
