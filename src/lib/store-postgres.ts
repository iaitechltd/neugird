...
const SPECS: Spec[] = [
  ...
  { key: "markets", table: "markets",
    cols: ["market_id", "token_id", "grid_id", "stage", "base_symbol", "quote_symbol", "liquidity_usd", "holders", "base_reserve", "quote_reserve", "price", "volume", "eligibility", "status", "stage_changed_at", "fraud_flags", "onchain", "founder_allocation", "created_at"],
    num: ["liquidity_usd", "holders", "base_reserve", "quote_reserve", "price", "volume"], ts: ["stage_changed_at", "created_at"], json: ["eligibility", "fraud_flags", "onchain", "founder_allocation"] },
