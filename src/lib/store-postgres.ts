...
const SPECS: Spec[] = [
  ...
  { key: "agents", table: "agents",
    cols: ["agent_id", "owner_id", "grid_id", "name", "capabilities", "permissions", "tools_granted", "task_history", "rating", "trading_rating", "status", "origin", "external_framework", "wallet_address", "reputation", "owner_split_bps", "trust_tier", "bond_amount", "spend_limit_per_job", "earnings", "api_key", "api_key_hash", "persona", "work", "skill_library", "created_at"],
    num: ["rating", "trading_rating", "owner_split_bps", "bond_amount", "spend_limit_per_job", "earnings"], ts: ["created_at"], json: ["reputation", "persona", "work", "skill_library"], arr: ["capabilities", "permissions", "tools_granted", "task_history"] },
  { key: "jobs", table: "jobs",
  ...
  { key: "proposals", table: "proposals",
    cols: ["proposal_id", "author_id", "title", "summary", "category", "mvp_ref", "track_record_ref", "roadmap", "ask_amount", "reward_token_terms", "status", "endorsements", "closes_at", "created_at"],
    num: ["ask_amount"], ts: ["closes_at", "created_at"], json: ["mvp_ref", "roadmap", "endorsements"] },
  ...
  { key: "markets", table: "markets",
    cols: ["market_id", "token_id", "grid_id", "stage", "base_symbol", "quote_symbol", "liquidity_usd", "holders", "base_reserve", "quote_reserve", "price", "volume", "eligibility", "status", "stage_changed_at", "fraud_flags", "created_at"],
    num: ["liquidity_usd", "holders", "base_reserve", "quote_reserve", "price", "volume"], ts: ["stage_changed_at", "created_at"], json: ["eligibility", "fraud_flags"] },
  ...
  { key: "wallets", table: "wallets",
    cols: ["user_id", "usdc", "grid"], num: ["usdc", "grid"] },
  { key: "listingStakes", table: "listing_stakes",
    cols: ["stake_id", "grid_id", "market_id", "staker_id", "amount", "stage_target", "locked_until", "released", "fees_earned", "created_at"],
    num: ["amount", "fees_earned"], ts: ["locked_until", "created_at"] },
  { key: "positions", table: "positions",
    cols: ["position_id", "market_id", "user_id", "side", "size", "leverage", "entry_price", "margin", "liquidation_price", "status", "opened_at", "closed_at", "pnl", "funding_paid", "last_funding_at", "take_profit", "stop_loss", "trailing_stop_pct", "trail_anchor", "close_reason", "mandate_id", "agent_id", "pnl_booked"],
    num: ["size", "leverage", "entry_price", "margin", "liquidation_price", "pnl", "funding_paid", "take_profit", "stop_loss", "trailing_stop_pct", "trail_anchor"], ts: ["opened_at", "closed_at", "last_funding_at"] },
  { key: "orders", table: "orders",
    cols: ["order_id", "market_id", "user_id", "side", "price", "qty", "filled", "status", "created_at", "filled_at", "kind", "pside", "collateral", "leverage", "take_profit", "stop_loss", "trailing_stop_pct"],
    num: ["price", "qty", "filled", "collateral", "leverage", "take_profit", "stop_loss", "trailing_stop_pct"], ts: ["created_at", "filled_at"] },
  ...
  { key: "agentActions", table: "agent_actions",
    cols: ["action_id", "mandate_id", "market_id", "agent_id", "kind", "rationale", "amount", "price", "pnl", "ok", "detail", "at"],
    num: ["amount", "price", "pnl"], ts: ["at"] },
  { key: "govProposals", table: "gov_proposals",
    cols: ["proposal_id", "kind", "title", "summary", "proposer_id", "status", "for_grid", "against_grid", "quorum_grid", "closes_at", "created_at", "resolved_at"],
    num: ["for_grid", "against_grid", "quorum_grid"], ts: ["closes_at", "created_at", "resolved_at"] },
